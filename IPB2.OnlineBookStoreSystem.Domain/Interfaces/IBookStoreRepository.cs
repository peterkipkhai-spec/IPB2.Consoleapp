...
public interface IBookStoreRepository
{
    ...
    Task UpdateAuthorAsync(int authorId, UpsertAuthorRequest request, CancellationToken ct = default);
    ...
    Task UpdateCategoryAsync(int categoryId, UpsertCategoryRequest request, CancellationToken ct = default);
    ...
    Task UpdateCustomerAsync(int customerId, UpsertCustomerRequest request, CancellationToken ct = default);
    ...
    Task UpdateBookAsync(int bookId, UpsertBookRequest request, CancellationToken ct = default);
